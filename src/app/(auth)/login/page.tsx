  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-blue-200 to-blue-300 p-6">
      ...
      >
        ...
        <p className="text-gray-600 text-center mt-6 text-lg">Don't have an account? <Link href="/signup" className="text-indigo-700 font-bold hover:underline">Sign Up</Link></p>
      </motion.div>
    </div>
  );
}
