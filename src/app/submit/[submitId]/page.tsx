...
export default function JobApplicationForm() {
  ...
  const params = useParams<{ submitId: string }>();
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateStep(currentStep)) {
      ...
      try {
        ...
        // Store data in Firestore with resume URL
        const docRef = await addDoc(collection(db, "applications"), {
          ...formData,
          jobId: params.submitId,
          resume: formData.resume?.name, // Store the file URL instead of the file itself
        });
